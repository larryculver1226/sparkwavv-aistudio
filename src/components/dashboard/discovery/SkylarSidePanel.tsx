  ...
  return (
    <div className="w-80 h-full bg-black/40 backdrop-blur-3xl border-l border-white/10 flex flex-col">
      ...
      <div className="p-8 border-b border-white/10">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-[10px] text-neon-cyan uppercase tracking-[0.2em] font-bold">Strategic Conductor</p>
          </div>
        </div>

        <div className="p-4 rounded-xl bg-neon-cyan/5 border border-neon-cyan/20">
          <p className="text-[11px] text-white/80 leading-relaxed italic">
            "I've analyzed your current trajectory against real-time market signals. Your velocity is optimal, but I recommend a strategic pivot to maximize resonance."
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-4">
        <h4 className="text-[10px] text-white/20 uppercase tracking-[0.3em] font-bold mb-4 px-2">Strategic Directives</h4>
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <div className={`px-2 py-0.5 rounded text-[8px] font-bold uppercase tracking-widest ${
                directive.priority === 'immediate' ? 'bg-neon-magenta/20 text-neon-magenta' :
                directive.priority === 'high' ? 'bg-neon-cyan/20 text-neon-cyan' :
            ...
            <h5 className="text-xs font-bold text-white mb-1 group-hover:text-neon-cyan transition-colors">{directive.title}</h5>
        ...
        {activeDirective && (
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-[10px] text-neon-lime uppercase tracking-widest font-bold">Recommended Action</span>
            </div>
