                        ...
                        >
                            ...
                            <div className="flex items-center gap-4">
                              <div
                                className={`w-12 h-12 rounded-xl flex items-center justify-center text-xl font-bold ${
                                  analysisResult.dnaResonance.score > 80
                                    ? 'bg-neon-cyan/10 text-neon-cyan'
                                    : analysisResult.dnaResonance.score > 60
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                              ...
                              <p className="text-sm font-bold capitalize text-neon-cyan">
                                {analysisResult.marketIntelligence.demand}
                              </p>
                            </div>
                            <div className="p-4 rounded-2xl bg-white/5 border border-white/5">
                              <p className="text-[10px] uppercase tracking-widest font-bold text-white/40 mb-2">
                              ...
                              <p className="text-sm font-bold text-white/80 truncate">
                                {analysisResult.outreachStrategy.primaryAngle}
                              </p>
                            </div>
                          </div>
                        </motion.div>
                  ...
                  <section>
                    ...
                    <div className="space-y-6">
                      <div className="glass-panel p-8 rounded-[2rem] border border-white/5 bg-black/40">
                        <label className="text-[10px] uppercase tracking-widest font-bold text-white/40 mb-4 block">
                          Target Company / Department
                        </label>
                        <input
                          type="text"
                          value={targetCompany}
                            ...
                            <div className="p-8 bg-white/5 rounded-3xl border border-white/10 text-white/80 leading-relaxed font-medium relative group">
                              {step.subject && (
                                <div className="mb-6 pb-6 border-b border-white/10">
                                  <span className="text-[10px] uppercase tracking-widest font-bold text-white/40 block mb-2">
                                    Subject:
                                  </span>
