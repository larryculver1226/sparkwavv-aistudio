  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-8">
        <div>
          <h3 className="text-xs font-bold text-neon-cyan uppercase tracking-[0.3em] mb-2">
        ...
        {phaseMilestones.length > 0 ? (
          phaseMilestones.map((m) => (
            ...
            >
              ...
              <p
                className={`text-sm font-medium leading-relaxed ${m.completed ? 'text-white/80' : 'text-white/40'}`}
              >
                {m.label}
              </p>
            </div>
          ...
          <div className="col-span-full py-12 text-center">
            <p className="text-white/20 italic text-sm">
              No specific milestones identified for this phase yet.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm font-bold text-white">
              Complete all {stage} milestones to unlock the next phase.
            </p>
          </div>
        </div>
        <button
