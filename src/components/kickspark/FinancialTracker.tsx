    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-bold text-white/40 uppercase tracking-widest">
          Financial Tracker (Tax Deductibility)
        </h3>
        <button
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="p-4 rounded-2xl bg-neon-lime/10 border border-neon-lime/20">
          ...
          <p className="text-xl font-display font-bold text-neon-lime">
      ...
      {isAdding && (
        <form
          ...
          className="p-4 rounded-2xl bg-white/5 border border-neon-cyan/30 space-y-4"
        >
          <input
            type="text"
          ...
          <button
            type="submit"
            className="w-full py-2 bg-neon-cyan text-black font-bold rounded-xl text-xs uppercase tracking-widest"
          >
            Add Investment
          </button>
        </form>
      ...
      <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
        {expenses.length === 0 ? (
          <p className="text-center py-8 text-xs text-white/20 italic">
