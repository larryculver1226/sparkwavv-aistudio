...
import { Clock, MoreVertical, CheckCircle2, AlertTriangle, XCircle, Sparkles, Brain, ArrowRight } from 'lucide-react';
...
export const TimelineFeed: React.FC<TimelineFeedProps> = ({ items, onSelectArtifact, onHoverArtifact }) => {
  return (
    <motion.div
      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <motion.div
            ...
            onClick={() => item.type === 'artifact' && onSelectArtifact(item.data as DistilledArtifact)}
          >
            {/* Hover Glow */}
