...
export const WavvaultExplorer: React.FC<WavvaultExplorerProps> = ({
  userId,
  events,
  artifacts,
}) => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-sans selection:bg-neon-cyan/30 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div
          className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-neon-magenta/5 rounded-full blur-[120px] animate-pulse"
      ...
      <CinematicReader artifact={selectedArtifact} onClose={() => setSelectedArtifact(null)} />
