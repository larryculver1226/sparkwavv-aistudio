        ...
        >
          ...
          <div className="prose prose-invert prose-cyan max-w-none space-y-8 text-white/70 leading-relaxed">
            <section className="space-y-4">
              ...
              <p>
                At SPARKWavv, we respect your privacy and are committed to protecting your personal
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Career Data:</strong> includes professional history, skills, and
                  aspirations provided during the ignition process.
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                contact us at:{' '}
                <a href="mailto:privacy@sparkwavv.com" className="text-neon-cyan hover:underline">
                  privacy@sparkwavv.com
                </a>
              </p>
            </section>
          </div>
