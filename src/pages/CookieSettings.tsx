        ...
        >
          <header className="space-y-4">
            ...
            <p className="text-white/40 text-lg max-w-2xl">
              Manage your cookie preferences. We use cookies to enhance your experience and analyze
              our traffic.
            </p>
          </header>
          ...
          <div className="space-y-6">
            <div className="glass-panel p-8 space-y-8">
              ...
              <div className="flex items-start justify-between gap-8">
                ...
                >
                  <div
                    className={`absolute top-1 w-4 h-4 rounded-full transition-all duration-300 ${settings.analytics ? 'right-1 bg-neon-cyan' : 'left-1 bg-white/40'}`}
                  />
                </button>
              </div>
              ...
              <div className="flex items-start justify-between gap-8">
                ...
                <button
                  onClick={() =>
                    setSettings((s) => ({ ...s, personalization: !s.personalization }))
                  }
                ...
                >
                  <div
                    className={`absolute top-1 w-4 h-4 rounded-full transition-all duration-300 ${settings.personalization ? 'right-1 bg-neon-cyan' : 'left-1 bg-white/40'}`}
                  />
                </button>
              </div>
              ...
              <div className="flex items-start justify-between gap-8">
                ...
                >
                  <div
                    className={`absolute top-1 w-4 h-4 rounded-full transition-all duration-300 ${settings.marketing ? 'right-1 bg-neon-cyan' : 'left-1 bg-white/40'}`}
                  />
                </button>
              </div>
            </div>
