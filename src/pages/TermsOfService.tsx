        ...
        >
          ...
          <div className="prose prose-invert prose-cyan max-w-none space-y-8 text-white/70 leading-relaxed">
            <section className="space-y-4">
              ...
              <p>
                By accessing or using SPARKWavv, you agree to be bound by these Terms of Service. If
            ...
            <section className="space-y-4">
              ...
              <p>
                SPARKWavv provides a career engine and discovery platform. You agree to use the
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                remain the exclusive property of SPARKWavv and its licensors. Our trademarks and
                trade dress may not be used in connection with any product or service without the
                prior written consent of SPARKWavv.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                In no event shall SPARKWavv, nor its directors, employees, partners, agents,
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                <a href="mailto:legal@sparkwavv.com" className="text-neon-cyan hover:underline">
                  legal@sparkwavv.com
                </a>
              </p>
            </section>
